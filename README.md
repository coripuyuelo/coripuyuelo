...
## Data Architect | Data Analytics Lead | BI Specialist
...
Argentina, vivo en Capital Federal, Buenos Aires.  
...
### Skills Técnicos
- **Lenguajes y Librerías:** SQL (Oracle, SQL Server, Teradata, BigQuery), Python (Pandas, NumPy, Selenium, Matplotlib, Seaborn), R, HTML, CSS, JavaScript  
- **Herramientas BI / Visualización:** QlikView, Qlik Sense, Tableau, Power BI, MicroStrategy  
- **ETL y Procesamiento de Datos:** PL/SQL, Transact-SQL, SQL Server Integration Services (SSIS), Qlik scripting, SAS Base, SAS AML  
- **Cloud y Plataformas:** AWS, Google Cloud Platform (GCP)  
- **Bases de Datos / NoSQL:** Oracle, SQL Server, Teradata, BigQuery, AWS (DynamoDB, Redshift, Athena)  
- **Sólida experiencia en:** Data Management, Data Quality, Data Governance, Modelado y Arquitectura de datos, Data Analytics  
- **Plataformas de Medición y Tracking:** AppSee, Firebase, AppsFlyer, Kochava, SAS Marketing Automation  
